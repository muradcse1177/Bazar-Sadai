...
@section('content')
    <main class="main">
        ...
        <div class="page-header" style="">
            <div class="container">
                <h1 class="page-title mb-0"> {{$cat}}</h1>
            </div>
        </div>
        <br>
                                ...
                                <div class="col-lg-9 col">
                                    <div class="btn-group row cols-sm-2">
                                        <div class="btn-wrap ml-0">
                                            <a href="{{url('customOrder')}}" class="btn btn-block btn-primary btn-rounded btn-icon-right">
                                                আপনার নতুন চাহিদা পোষ্ট করুন<i class="w-icon-long-arrow-right"></i>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card" style="margin-bottom: 20px;">
                            <div class="card-body cardBody">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p style="margin-top: -10px; text-align: justify;"><b>Product/Service Details: </b>{!! nl2br($order['details']) !!}</p>
                                    <div>
