...
@section('title', 'Transport || Bazar-Sadai.com Best online Shop in Bangladesh')
...
@section('content')
    <main class="main">
        ...
        <div class="page-header" style="margin-top: -1px;">
            <div class="container">
                <h1 class="page-title mb-0">পরিবহন সার্ভিস </h1>
            </div>
        </div>
        <br>
                            ...
                            <div class="serviceArea" style="text-align: center;">
                                @if(Cookie::get('user_id'))
                                    <div class="form-group">
                                        <a href="{{url('serviceArea')}}" type="submit" class="btn btn-success">সার্ভিস এরিয়া</a>
                                    </div>
                                @endif
...
@section('js')
    <script>
        ...
        $("#private, #micro, #ambulance,#truck").click(function(){
            ...
            $.ajax({
                type: 'GET',
                url: '{{url('/')}}/getAddressGroupPrivate',
                data: {type:parVal},
                dataType: 'json',
                success: function(response){
                    var data = response.data;
                    if(data==0){
                        ...
                        if(addressType == 1){
                            $('.upz_namePri').find('option:not(:first)').remove();
                        ...
                        if(addressType == 2){
                            $('.co_namePri').find('option:not(:first)').remove();
                ...
                success: function(response){
                    ...
                    if(data==0){
                        ...
                        if(addressType == 2){
                            ...
                            $('.co_namep').find('option:not(:first)').remove();
                            $("#cityGroupId").show();
