            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                @if(Cookie::get('user_type') == 4)
                    <li class="@yield('myShop')">
                        <a href ="{{ url('myShop') }}" >
                            <i class="fa fa-shopping-basket"></i> <span>আমার দোকান</span>
                        </a>
                    </li>
                    <li class="@yield('importProduct')">
                        <a href ="{{ url('importProduct') }}" >
                            <i class="fa fa-sellsy"></i> <span>পণ্য ইম্পোর্ট</span>
                        </a>
                    </li>
                    ...
                    <li class="treeview  @yield('serviceMainLi')">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="treeview  @yield('tntMainLi')">
                                ...
                                <ul class="treeview-menu">
                                    <li class ="@yield('travelSlide')"><a href="{{ url('travelSlide') }}"><i class="fa fa-circle-o"></i>ট্রাভেল স্লাইড </a></li>
