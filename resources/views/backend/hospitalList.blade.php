        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="divform" style="display:none">
                    {{ Form::open(array('url' => 'insertHospital',  'method' => 'post')) }}
                    {{ csrf_field() }}
                    <div class="box-body">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-bordered">
                        ...
                        @foreach($hospitalLists as $hospitalList)
                            <tr>
                                <td> {{$hospitalList->hos_name}} </td>
                                <td> {{$hospitalList->dept_name}} </td>
                                <td class="td-actions text-center">
                                    <button type="button" rel="tooltip" class="btn btn-success edit" data-id="{{$hospitalList->hos_id}}">
                                        <i class="fa fa-edit"></i>
                                    </button>
                                    <button type="button" rel="tooltip"  class="btn btn-danger delete" data-id="{{$hospitalList->hos_id}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    {{ Form::open(array('url' => 'deleteHospital',  'method' => 'post')) }}
                                    {{ csrf_field() }}
