...
class TransportController extends Controller
{
    ...
    public function insertServiceArea(Request $request){
        ...
        if ($rows > 0) {
            ...
            if ($result) {
                return redirect('transportService/1')->with('successMessage', 'সফলভাবে  সম্পন্ন  হয়েছে।');
            } else {
                return back()->with('errorMessage', 'আবার চেষ্টা করুন।');
            }
        }
            ...
            if ($result) {
                return redirect('transportService')->with('successMessage', 'সফলভাবে  সম্পন্ন  হয়েছে।');
            } else {
                return back()->with('errorMessage', 'আবার চেষ্টা করুন।');
            }
        }
    ...
    public function insertServiceAreaCourier(Request $request){
        ...
        if ($rows > 0) {
            ...
            if ($result) {
                return redirect('courier/1')->with('successMessage', 'সফলভাবে  সম্পন্ন  হয়েছে।');
            } else {
                return back()->with('errorMessage', 'আবার চেষ্টা করুন।');
            }
        }
            ...
            if ($result) {
                return redirect('courier')->with('successMessage', 'সফলভাবে  সম্পন্ন  হয়েছে।');
            } else {
                return back()->with('errorMessage', 'আবার চেষ্টা করুন।');
            }
        }
