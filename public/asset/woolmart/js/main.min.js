        ...
        var e = {
            init: function() {
                ...
                Wolmart.call(Wolmart.ratingTooltip, 500), Wolmart.call(Wolmart.setProgressBar(".progress-bar"), 500), this.initProductType("slideup"), this.initVariation(), this.initProductsScrollLoad(".scroll-load"), Wolmart.$body.on("mousedown", ".select-menu", function(e) {
                    ...
                    //     }
                    //     i.length || document.body.classList.contains("docs") || (t(".page-wrapper").
                    //     append('<div class="compare-popup">                    <div class="container">         ' +
                    //         '               <div class="compare-title">                     ' +
                    //         '       <h4 class="title title-center">Compare Products</h4>               ' +
                    //         '         </div>                        <ul class="compare-product-list list-style-none">          ' +
                    //         '                  <li></li><li></li><li></li><li></li>                        </ul>       ' +
                    //         '                 <a href="#" class="btn btn-clean">Clean All</a>         ' +
                    //         '               <a href="compare.html" class="btn btn-dark btn-rounded">Start Compare !</a>      ' +
                    //         '              </div>                </div>                <div class="compare-popup-overlay">     ' +
                    //         '           </div>'), i = t(".page-wrapper > .compare-popup")), Wolmart.$body.on("click", ".product .btn-compare", function(n) {
                    //         var s = t(this);
